<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:71:"D:\www\jxc\public/../application/admin\view\cashregister\setmember.html";i:1527044009;s:53:"D:\www\jxc\application\admin\view\layout\default.html";i:1525765390;s:50:"D:\www\jxc\application\admin\view\common\meta.html";i:1525765390;s:52:"D:\www\jxc\application\admin\view\common\script.html";i:1525765390;}*/ ?>
<!DOCTYPE html>
    ...
    <div style="display: flex;text-align:center;">
        <div style="width:60%;">
            <div class="form-group">
                <label for="c-mobile" class="control-label col-xs-12 col-sm-2">会员:</label>
                <div class="col-xs-12 col-sm-8">
                    <input id="c-mobile" class="form-control focus" size="50" type="text" value="<?php echo $mobile; ?>" data-rule="required;" >
                </div>
            </div>
            <div style="width:95%;">
